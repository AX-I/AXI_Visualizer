            ...
            if ((cy >= 0) && (cy < hF) && (ax >= 0) && (ax < wF)) {
              ...
              if (F[wF * cy + ax] > tz) {
                ...
                */
                ...
                tex10 = min(tex1+1, 6*lenR-1) + 6*lenR*tex2;
                tex01 = tex1 + 6*lenR*min(tex2+1, lenR-1);
                tex11 = min(tex1+1, 6*lenR-1) + 6*lenR*min(tex2+1, lenR-1);
                texi1 = 1-texr1;
                texi2 = 1-texr2;
                ...
                Ro[wF * cy + ax] = convert_ushort_sat(Rout / 4096.f * (texi1*texi2*RR[tex] + texr1*texi2*RR[tex10] + texi1*texr2*RR[tex01] + texr1*texr2*RR[tex11]));
                Go[wF * cy + ax] = convert_ushort_sat(Gout / 4096.f * (texi1*texi2*RG[tex] + texr1*texi2*RG[tex10] + texi1*texr2*RG[tex01] + texr1*texr2*RG[tex11]));
                Bo[wF * cy + ax] = convert_ushort_sat(Bout / 4096.f * (texi1*texi2*RB[tex] + texr1*texi2*RB[tex10] + texi1*texr2*RB[tex01] + texr1*texr2*RB[tex11]));
