...
// Per-pixel lighting on one directional light - subract from vertex lighting
              ...
              if (F[wF * cy + ax] > tz) {
                ...
                */
                ...
                outR += (ushort)((texi1*texi2*TR[tex] + texr1*texi2*TR[tex10] +
                                   texi1*texr2*TR[tex01] + texr1*texr2*TR[tex11])
                                   * (light * col.x + (1-light) * max((col.x - dirCol.x),0.f)) * fmip);
                outG += (ushort)((texi1*texi2*TG[tex] + texr1*texi2*TG[tex10] +
                                   texi1*texr2*TG[tex01] + texr1*texr2*TG[tex11])
                                   * (light * col.y + (1-light) * max((col.y - dirCol.y),0.f)) * fmip);
                outB += (ushort)((texi1*texi2*TB[tex] + texr1*texi2*TB[tex10] +
                                   texi1*texr2*TB[tex01] + texr1*texr2*TB[tex11])
                                   * (light * col.z + (1-light) * max((col.z - dirCol.z),0.f)) * fmip);
                Ro[wF * cy + ax] = outR;
                Go[wF * cy + ax] = outG;
                Bo[wF * cy + ax] = outB;
