// Additive drawing 2d sprites for particle systems
            ...
            if ((cy >= 0) && (cy < hF) && (ax >= 0) && (ax < wF)) {
              ...
              if (F[wF * cy + ax] > tz) {
                ...
                Ro[wF * cy + ax] = convert_ushort_sat((texi1*texi2*TR[tex] + texr1*texi2*TR[tex10] +
                                   texi1*texr2*TR[tex01] + texr1*texr2*TR[tex11]) * light * col.x);
                Go[wF * cy + ax] = convert_ushort_sat((texi1*texi2*TG[tex] + texr1*texi2*TG[tex10] +
                                   texi1*texr2*TG[tex01] + texr1*texr2*TG[tex11]) * light * col.y);
                Bo[wF * cy + ax] = convert_ushort_sat((texi1*texi2*TB[tex] + texr1*texi2*TB[tex10] +
                                   texi1*texr2*TB[tex01] + texr1*texr2*TB[tex11]) * light * col.z);
                */
                float3 col = ((1-t)*cl2 + t*cl1);
