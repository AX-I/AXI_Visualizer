        ...
        for tn in range(len(self.gSize)):
            ...
            if newSize[tn] > 0:
                if "alpha" in shaders[tn]:
                    ...
                    drawM.drawSmall(cq, (ns, 1), (BLOCK_SIZE, 1),
                             self.TOA[tn],
                             self.RO, self.GO, self.BO,
                             self.DB, self.SP[tn], self.ZZ[tn],
                             self.UV[tn], self.LI[tn], self.VN[tn], self.XYZ[tn],
                             ...
                             self.TR[tn], self.TG[tn], self.TB[tn],
                             self.texSize[tn],
                            self.TR[tn+1], self.TG[tn+1], self.TB[tn+1],
                             self.texSize[tn+1],
                             self.TR[tn+2], self.TG[tn+2], self.TB[tn+2],
                             self.texSize[tn+2],
                             self.TR[tn+3], self.TG[tn+3], self.TB[tn+3],
                             self.texSize[tn+3],
                             self.W, self.H, np.int32(newSize[tn]),
                             g_times_l=True)
                else:
                    draw.drawSmall(cq, (ns, 1), (BLOCK_SIZE, 1),
                             self.TOA[tn],
                             self.RO, self.GO, self.BO,
                             self.DB, self.SP[tn], self.ZZ[tn],
                             self.UV[tn], self.LI[tn], self.VN[tn], self.XYZ[tn],
        ...
        for tn in range(len(self.gSize)):
            ...
            if newSize[tn] > 0:
                ...
                if "alpha" in shaders[tn]:
                    ...
                    drawM.draw(cq, (self.WC * self.HC, 1), (BLOCK_SIZE, 1),
                             self.IBUF, self.NBUF,
                             self.RO, self.GO, self.BO,
                             self.DB, self.SP[tn], self.ZZ[tn],
                             self.UV[tn], self.LI[tn], self.VN[tn], self.XYZ[tn],
...
##                             g_times_l=True).wait()
                    ...
                    draw.draw(cq, (self.WC * self.HC, 1), (BLOCK_SIZE, 1),
                             self.IBUF, self.NBUF,
                             self.RO, self.GO, self.BO,
                             self.DB, self.SP[tn], self.ZZ[tn],
                             self.UV[tn], self.LI[tn], self.VN[tn], self.XYZ[tn],
